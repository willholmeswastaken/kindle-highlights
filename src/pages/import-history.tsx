            ...
            <div className="flex flex-col w-full gap-y-4 sm:gap-y-8">
                ...
                <div className="rounded-lg w-full lg:w-3/4 p-4">
                    <div className="flex flex-col gap-y-5">
                        {
                            imports.isLoading && <h3>Loading...</h3>
                        }
                        {
                            imports.data && imports.data.length > 0
                                ? imports.data.map(x => {
                                    return <div key={x.id} className="flex flex-row bg-white rounded-lg hover:bg-gray-50 h-16 border-y border-y-gray-100 py-3 px-2">
                                        ...
                                        <button type="button" className="text-red-600 font-semibold w-16 h-7 mt-1 rounded-lg" onClick={() => onVaultInteractionClicked(x)}>
                                            {x.vaultRecord ?
