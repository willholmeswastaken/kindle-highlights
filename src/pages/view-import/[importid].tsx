...
const ViewImport: NextPage = () => {
    ...
    const books = trpc.useQuery(["highlights.getBooksByImportId", {
                    ...
                    <div className="flex flex-col gap-y-5">
                        {
                            books.data
                                ? books.data.map(x => {
                                    return <div className="flex flex-row bg-white rounded-lg hover:bg-gray-50 h-16 border-y border-y-gray-100 py-3 px-2 hover:cursor-pointer" key={x.id}>
